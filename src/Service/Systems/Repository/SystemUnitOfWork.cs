using Portolo.Systems.Repository;
...
{
    public class SystemUnitOfWork : IDisposable
    {
        private SystemContext dbContext;
        ...
        public SystemUnitOfWork(string dbConncetion)
        {
        ...
        public IApplicationSettingsRepository ApplicationSettingsRepository
        {
            get
            {
                ...
                {
                    this.dbContext = new SystemContext(this.DbConnection);
